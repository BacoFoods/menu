    ...
    "paths": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/scheduler.RequestHoliday"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/scheduler.Holiday"
                        }
                    }
                ],
                "responses": {
        ...
        "/siesa/JSON": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Request body for creating JSON file",
                        "name": "siesa",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/siesa/reference": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "PDV Reference",
                        "name": "referencia_pdv",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "Delivery Inline Reference",
                        "name": "referencia_delivery_inline",
                        "in": "query"
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/siesa.Reference"
                        }
                    }
                ],
                "responses": {
        ...
        "/siesa/run": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Request body for running the integration",
                        "name": "siesa",
                        "in": "body",
                        "required": true,
                        "schema": {
    ...
    "definitions": {
        ...
        "tables.Table": {
            ...
            "properties": {
                ...
                "order_id": {
                    "description": "An order can only be assigned to one table and be active",
                    "type": "integer"
                },
                "qr": {
