...
func (h Handler) Create(c *gin.Context) {
	...
	newZone, err := h.service.Create(&zone)
	if err != nil {
...
// AddTablesToZone to handle a request to add tables to a zone
// @Tags Zones
...
// @Failure 422 {object} shared.Response
// @Failure 403 {object} shared.Response
// @Router /zone/{id}/tables [post]
func (h Handler) AddTablesToZone(c *gin.Context) {
	id := c.Param("id")
	...
	err := h.service.AddTablesToZone(id, req.Tables)
	if err != nil {
